# 2026 NBA Draft Big Board, Full Research Project (Codex Edition)
...
3. **Be honest about video.** If you cannot perceive images or motion, say so and rely on aggregated human scouting reports, clearly cited. If you can read images, frame-sampled film study is still only a supplementary signal. Label your own film observations separately from sourced human scouting. Never present a frame-based observation as if you watched live film.
...
3. If you can read images, evaluate what frames can actually support: shooting mechanics (set point, release height, base, follow-through), body frame and build in game context, defensive stance, handle posture, finishing angles. If you cannot read images, skip frame interpretation, still build the clip/frame archive, and substitute a deeper sourced-scouting synthesis, clearly labeled as such.
...
- Work the phases roughly in order. Phase 1 dossier collection, Phase 2 historical scraping, and Phase 4 clip downloads are independent and can be batched.
